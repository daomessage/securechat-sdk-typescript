...
export class SecureChatClient {
  ...
  public readonly events: PublicEventBus
  ...
  constructor(opts: SecureChatClientOptions = {}) {
    ...
    this.contacts = new ContactsModule(this.http, this._bus)
    this.messages = new MessagesModule(this._messageInner, this._bus)
    this.media = new MediaModule(new MediaInner(this.http), this._bus)
